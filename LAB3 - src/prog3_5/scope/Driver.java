...
import prog3_5.scope.more.*;

/*
 *  I did not complete this assignment because the PDF says that its optional
 */
...
public class Driver {
	...
	void displayNumberOfEmployees() {
		...
		if(numemps > -1){
			System.out.println("Number of employees is: " + numemps +" (Look for other console messages.)"+n+CONTINUE);
		}

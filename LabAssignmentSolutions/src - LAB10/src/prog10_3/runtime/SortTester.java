...
import prog10_3.util.RandomPermutations;
import java.util.*;
...
public class SortTester {
	...
	private final String PACKAGE = "prog10_3.sortroutines";
	...
	public void runTests() {
		...
		while(!sorters.isEmpty()) {
			...
			String name = prog10_3.util.Util.getClassNameNoPackage(nextSorter.getClass());
